    ...
    const render = () => {
        ...
        const menuitm = `
            <li id="spcamp-time" class="nav__item" data-menu-section="time">
                <a class="nav__link" href="${timeChimpUrl}"  onClick="navigator.clipboard.writeText('${clipboardText}')" target="blank">
    ...
    const render = () => {
        ...
        const menuitm = `
            <span id="spcamp-time" class="badge">
                <a href="${timeChimpUrl}" onClick="navigator.clipboard.writeText('${clipboardText}')" target="blank">Time</a>
            </span>
        `;
